...
//            viewHolder.tv_2 = (TextView) view.findViewById(R.id.tv_2);
        ...
        if (null == detail.get(position).getSc()) {
            ...
            span.setSpan(new ForegroundColorSpan(mcontext.getResources().getColor(R.color.blue_00ffff)), t1.length() + 1, t.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
